...
private package Ropes.String_Impl is
    ...
    type String_Impl is abstract new Ropes.Rope_Impl with record
        S : String_Access;
   end record;

  -- overriding
--   function "&" (Left : access String_Impl; Right : String) return Rope_Impl_Access;

   --overriding
   --function "&" (Left : String; Right : access String_Impl) return Rope_Impl_Access;

   type Large_String_Impl is new Ropes.Rope_Impl with record
      S : String_Access;
   end record;

   overriding
   function "&" (Left : access Large_String_Impl; Right : String) return Rope_Impl_Access;

   overriding
   function "&" (Left : String; Right : access Large_String_Impl) return Rope_Impl_Access;
   ...
   type Small_String_Impl is new Ropes.Rope_Impl with record
      S : String(1..Max_Small_String);
   end record;

   overriding
   function "&" (Left : access Small_String_Impl; Right : String) return Rope_Impl_Access;

   overriding
   function "&" (Left : String; Right : access Small_String_Impl) return Rope_Impl_Access;
