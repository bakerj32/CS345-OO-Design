...
package body Ropes.Concat_Impl is
   ...
   overriding
   function "&" (Left : access Concat_Impl; Right : String) return Rope_Impl_Access is
   begin
      Left.R := Left.R & Right;
   ...
   overriding
   function "&" (Left : String; Right : access Concat_Impl) return Rope_Impl_Access is
   begin
      Right.L := Left & Right.L;
