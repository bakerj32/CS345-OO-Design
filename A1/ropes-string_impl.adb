...
package body Ropes.String_Impl is
   ...
   overriding
   function "&" (Left : access Large_String_Impl; Right : String) return Rope_Impl_Access is
     Str : constant String_Access := new String(1 .. Right'Length + Left.Length);
     Large_Impl : constant Rope_Impl_Access := new Large_String_Impl'(Ref_Count => 0, Length => Right'Length + Left.Length, S => Str);
   begin
   	Str.all := Left.S(Left.S'First .. Left.S'Last) & Right;
   ...
   overriding
   function "&" (Left : String; Right : access Large_String_Impl) return Rope_Impl_Access is
      Str : constant String_Access := new String(1 .. Left'Length + Right.Length);
      Large_Impl : constant Rope_Impl_Access := new Large_String_Impl'(Ref_Count => 0, Length => Left'Length + Right.Length, S => Str);
   begin
      Str.all := Right.S(Right.S'First .. Right.S'Last) & Left;
      return Large_Impl;
   end "&";
   ...
   function "&" (Left : access Small_String_Impl; Right : String) return Rope_Impl_Access is
   begin
      if (Right'Length + Left.Length) > Max_Small_String then
         declare
            	Str : constant String_Access := new String(1 .. Right'Length + Left.Length);
        	Large_Impl : constant Rope_Impl_Access := new Large_String_Impl'(Ref_Count => 0, Length => Right'Length + Left.Length, S => Str);
         begin
         ...
         declare
            	Str : constant String(1 .. Left.Length + Right'Length) := Left.S(Left.S'First .. Left.S'Last) & Right;
        	Small_Impl : constant Rope_Impl_Access := new Small_String_Impl'(Ref_Count => 0, Length => Right'Length + Left.Length, S => Str);
         begin
   ...
   function "&" (Left : String; Right : access Small_String_Impl) return Rope_Impl_Access is
   begin
      if (Left'Length + Right.Length) > Max_Small_String then
         declare
        	...
        	Large_Impl : constant Rope_Impl_Access := new Large_String_Impl'(Ref_Count => 0, Length => Left'Length + Right.Length, S => Str);
         begin
        	Str.all := Left & Right.S(Right.S'First .. Right.S'Last);
        	Inc_Ref_Count (Large_Impl);
         	Dispose(Right);
            	return Large_Impl;
         end;
         ...
         declare
            	Str : constant String(1 .. Left'Length + Right.Length) :=  Left & Right.S(Right.S'First .. Right.S'Last);
        	Small_Impl : constant Rope_Impl_Access := new Small_String_Impl'(Ref_Count => 0, Length => Right.Length + Left'Length, S => Str);
         begin
            	Inc_Ref_Count (Small_Impl);
            	Dispose(Right);
