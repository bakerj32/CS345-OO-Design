...
private
   ...
   function "&" (Left : access Rope_Impl; Right : String) return Rope_Impl_Access is abstract;
   function "&" (Left : String; Right : access Rope_Impl) return Rope_Impl_Access is abstract;
